(ns aoc2018.d04-test
  (:require [aoc2018.d04 :refer [solve-1 solve-2]]
...
(def input "[1518-11-07 00:21] falls asleep
...
(deftest part-1
  (testing "example"
    (is (= 240 (solve-1 example))))

  (testing "input"
    (is (= 74743 (solve-1 input)))))


(deftest part-2
  (testing "example"
    (is (= 4455 (solve-2 example))))

  (testing "input"
    (is (= 132484 (solve-2 input)))))
